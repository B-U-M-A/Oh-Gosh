...
import OptionsScene from './scenes/OptionsScene' // ADD THIS LINE
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [PreloaderScene, MainMenuScene, Level1Scene, GameOverScene, PauseScene, CreditsScene, WinScene, OptionsScene], // MODIFY THIS LINE: Add OptionsScene
  physics: {
    default: 'arcade',
    arcade: {
      gravity: { x: 0, y: 0 },
